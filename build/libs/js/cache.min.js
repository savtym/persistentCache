  ...
  _createClass(Persistent, [{
    ...
    */
    ...
    value: function insert(key, data, sizeData) {
      ...
      if (typeof values[key] !== 'undefined' && JSON.stringify(values[key]) === JSON.stringify(data)) {
    ...
    */
    ...
    set: function set(value) {
      ...
      if (!isNaN(value) && value >= 0) {
        ...
        if (value < this.busyMemory) {
          var overwriting = Storage._leastRecentlyUsed(this._lifeTime, this.busyMemory - value);
          var values = this.data();
          ...
          try {
            for (var _iterator2 = overwriting[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    key: 'busyMemory',
    get: function get() {
      return Storage.sizeOf(localStorage.getItem(this._id));
    }
  }, {
    key: 'freeMemory',
    get: function get() {
      return this._maxMemory - Storage.sizeOf(localStorage.getItem(this._id));
    }
  }], [{
    key: 'counterRequest',
    get: function get() {
...
var RAM = function () {
  ...
  _createClass(RAM, [{
    ...
    key: 'freeMemory',
    get: function get() {
      return this.maxMemory - this._busyMemory;
    }
  }]);
...
var Storage = function () {
  function Storage(_ref) {
    var sizeRAM = _ref.sizeRAM,
        sizeLocal = _ref.sizeLocal,
        _ref$id = _ref.id,
        id = _ref$id === undefined ? idMemory : _ref$id;
